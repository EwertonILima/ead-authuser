...
import com.ewertonilima.authuser.configs.security.AuthenticationCurrentUserService;
import com.ewertonilima.authuser.configs.security.UserDetailsImpl;
...
public class UserController {
    ...
    public UserController(AuthenticationCurrentUserService authenticationCurrentUserService) {
    ...
    public ResponseEntity<Object> updatePassword(@PathVariable(value = "userId") UUID userId,
        ...
        if (!userModelOptional.get().getPassword().equals(userDto.getOldPassword())) {
            log.warn("Password Mismatched old password userId {} ", userModelOptional.get().getUserId());
